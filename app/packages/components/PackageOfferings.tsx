  ...
  return (
    <section className="bg-cool-white py-16 lg:py-28 px-6 lg:px-12" aria-labelledby="packages-section-heading">
      ...
      <div className="mx-auto max-w-7xl">
              ...
              >
                ...
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div className="text-right flex-shrink-0">
                    ...
                    <span className="font-body text-slate/75 text-sm ml-1">+ tax</span>
                    <p className="font-body text-slate/75 text-xs mt-1 tracking-wide">
                      {pkg.priceUnit}
                    </p>
                  </div>
                </div>
                ...
                <ul className="flex flex-col gap-3">
                  {pkg.includes.map((item) => (
                    <li key={item} className="flex items-start gap-3 font-body text-slate/75 text-sm leading-relaxed">
                      <span className="mt-0.5 flex-shrink-0 w-4 h-4 rounded-full bg-slate/15 flex items-center justify-center" aria-hidden="true">
              ...
              >
                <div className="flex items-start justify-between gap-3">
                  ...
                  <div className="text-right flex-shrink-0">
                    ...
                    <span className="font-body text-slate/75 text-xs ml-0.5">+ tax</span>
                    <p className="font-body text-slate/75 text-xs mt-1 tracking-wide">
                      {pkg.priceUnit}
                    </p>
                  </div>
        ...
        {/* Pricing disclaimer */}
        <FadeIn delay={0.2}>
          <p className="font-body text-slate/75 text-sm text-center mt-10 max-w-xl mx-auto leading-relaxed">
